...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
	...
	I2C_PeripheralClockControl(pI2CHandle->pI2Cx,ENABLE); //enable the clock for the i2cx peripheral
...
void I2C_EV_IRQHandling(I2C_Handle_t *pI2CHandle)
{
	...
	{
		//STOF flag is set
		//Clear the STOPF ( i.e 1.) read SR1(we did this when read stopf bit) 2. Write to CR1 )
